...
public abstract class AbstractUser implements java.io.Serializable {
	...
	/** full constructor */
	public AbstractUser(String userName, String password, Integer phoneNumber, String gender, String userPhoto,
			Set orderTablesForBuyerId, Set orderTablesForSellerId, Set goods) {
		this.userName = userName;
		this.password = password;
